...
import BtnAuth0 from './btn-auth0'
    ...
    return (
      <div id='sign-in'>
        <div className='title-page'>
          ...
          {!config.facebookSignin && !config.auth0Signin && (
            <div className='title-page'>
        ...
        {config.auth0Signin && <Auth0Form />}
        {!config.auth0Signin && form}
      </div>
    )
  }
}
